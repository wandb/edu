...
Please make sure libcudnn_cnn_infer.so.8 is in your library path", [add the following config](https://discuss.pytorch.org/t/libcudnn-cnn-infer-so-8-library-can-not-found/164661). Check the config with `$cat ~/.bashrc`.  
