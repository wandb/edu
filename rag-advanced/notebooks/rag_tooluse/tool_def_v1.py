...
def search_code_examples(
    ...
    code_examples = [
        {
            "content": "Selecting Hyperparameters with Sweeps (Keras)",
            "file_type": "py",
            "language": "en",
        },
        {
            "content": "Interactive W&B Charts Inside Jupyter",
            "file_type": "ipynb",
            "language": "en",
        },
        {"content": "ロギングメディア", "file_type": "py", "language": "ja"},
        {
            "content": "テーブルを使用してデータセットと予測を視覚化する",
            "file_type": "ipynb",
            "language": "ja",
        },
        {
            "content": "Model/Data Versioning with Artifacts (PyTorch)",
            "file_type": "ipynb",
            "language": "en",
        },
        {
            "content": "Create a hyperparameter search with W&B PyTorch integration",
            "file_type": "ipynb",
            "language": "en",
        },
        {
            "content": "Get started with W&B Weave",
            "file_type": "ipynb",
            "language": "en",
        },
    ]
    ...
    filtered_code_examples = [
        ...
        if (item["file_type"] == file_type if file_type else True)
        and (
            item["programming_language"] == programming_language
            if programming_language
            else True
        )
        and (item["language"] == language if language else True)
    ]
...
search_tools = [
    ...
    },
    {
        ...
        "description": "Returns a list of relevant document snippets for a textual query retrieved from the internet. Use this tool for general queries about Weights & Biases or others.",
        "parameter_definitions": {
            "query": {
                "description": "Query to search the internet with. If you have more than one query, call this tool multiple times.",
                "type": "str",
                "required": True,
            }
        },
