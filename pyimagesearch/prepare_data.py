...
if __name__ == "__main__":
    ...
    path_to_raw_data = Path(params.RAW_DATA_FOLDER)
    data_at = wandb.Artifact(params.DATA_AT, type="dataset")
    data_at.add_dir(path_to_raw_data / "images", name="images")
    ...
    data = json.load(open(params.ANNOTATIONS_FILE, encoding="utf-8"))
